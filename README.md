...
where Sample is the sample name, Mass is the sample mass in grams, MeasTime is the measurement time, ActTime is the activation time, and x, y are the identification
numbers of the β- and γ-detectors used in the measurement, respectively.

Simulation Data:

All files have 3 columns, 1st column: neutron energy (eV), 2nd column: spectral fluence (cm^{-2}eV^{-1}) and 3rd column: statistical spectral fluence uncertainty (cm^{-2}eV^{-1}).
